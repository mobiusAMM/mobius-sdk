...
import { CELO, ChainId, MobiPair, Percent, Route, Router, Token, TokenAmount, Trade } from '../src'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new MobiPair(new TokenAmount(CELO[ChainId.MAINNET], '1000'), new TokenAmount(token0, '1000'))
